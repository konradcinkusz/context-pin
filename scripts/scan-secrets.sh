...
#
# A script that reproduces a CI job 1:1 so the job can be debugged without pushing
# a commit. The default mode scans the full history exactly as
# .github/workflows/secret-scan.yml does, so "it passed locally" means something.
# Ported from konradcinkusz/architecture-standards.
#
# Usage:
